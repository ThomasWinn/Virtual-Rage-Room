...
public class SwordBehaviorRed : MonoBehaviour
{
    ...
    void OnCollisionEnter(Collision collision)
    {
        ...
        if (collision.gameObject.name == "cubey_red" || collision.gameObject.name == "cubey_red(Clone)")
        {
            switch (cube_type)
            {
                case 0:
        ...
        /*
        // DOWN
        if ((collision.gameObject.name == "cubey_red" || collision.gameObject.name == "cubey_red(Clone)") && (cube_type == 0 && (swingAngle >= -180 && swingAngle <= -126) || (swingAngle >= 126 && swingAngle <= 180)))
        {
            Debug.Log(cube_type);
            Debug.Log("DOWN DESTROY");
            destroyed = true;
        ...
        // RIGHT
        else if ((collision.gameObject.name == "cubey_red" || collision.gameObject.name == "cubey_red(Clone)") && (cube_type == 1 && (swingAngle >= 35 && swingAngle <= 125)))
        {
            Debug.Log(cube_type);
            Debug.Log("RIGHT DESTROY");
            destroyed = true;
        ...
        // LEFT
        else if ((collision.gameObject.name == "cubey_red" || collision.gameObject.name == "cubey_red(Clone)") && (cube_type == 2 && (swingAngle >= -125 && swingAngle <= -35)))
        {
            Debug.Log(cube_type);
            Debug.Log("LEFT DESTROY");
            destroyed = true;
        ...
        // UP
        else if ((collision.gameObject.name == "cubey_red" || collision.gameObject.name == "cubey_red(Clone)") && (cube_type == 3 && (swingAngle >= -34 && swingAngle <= 34)))
        {
            Debug.Log(cube_type);
            Debug.Log("UP DESTROY");
            destroyed = true;
